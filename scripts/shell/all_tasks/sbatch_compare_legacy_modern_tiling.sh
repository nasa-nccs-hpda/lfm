#!/usr/bin/env bash
#SBATCH --job-name=compare_tiling
#SBATCH --partition=grace
#SBATCH --mem=96G
#SBATCH --cpus-per-task=8
#SBATCH --time=04:00:00
#SBATCH --output=scripts/logs/compare_tiling_%j.out
#SBATCH --error=scripts/logs/compare_tiling_%j.err
...
SCRIPT_REL="scripts/python/all_tasks/compare_legacy_modern_tiling.py"
...
OUTPUT_DIR="${OUTPUT_DIR:-/explore/nobackup/people/${USER}/lfm_tiling_comparison_${SLURM_JOB_ID:-manual}}"
...
echo
echo "Legacy/modern tiling comparison completed successfully."
echo "Report: ${OUTPUT_DIR}/comparison_report.json"
