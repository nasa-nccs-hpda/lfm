#!/usr/bin/env bash
#SBATCH --job-name=static_cube_nd
#SBATCH --partition=grace
#SBATCH --mem=64G
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=scripts/logs/static_cube_nd_%j.out
#SBATCH --error=scripts/logs/static_cube_nd_%j.err
...
SCRIPT_REL="scripts/python/all_tasks/diagnose_static_cube_nodata.py"
...
OUTPUT_DIR="${OUTPUT_DIR:-/explore/nobackup/people/${USER}/lfm_static_cube_nodata_${SLURM_JOB_ID:-manual}}"
...
echo
echo "Static cube NoData diagnostic completed successfully."
echo "Report: ${OUTPUT_DIR}/static_cube_nodata_report.json"
