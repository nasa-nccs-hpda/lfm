#!/usr/bin/env bash
#SBATCH --job-name=validate_mixed_tiling
#SBATCH --partition=grace
#SBATCH --mem=64G
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=scripts/logs/validate_mixed_tiling_%j.out
#SBATCH --error=scripts/logs/validate_mixed_tiling_%j.err
...
SCRIPT_REL="scripts/python/all_tasks/validate_mixed_wac_static_tiling.py"
...
OUTPUT_DIR="${OUTPUT_DIR:-/explore/nobackup/people/${USER}/lfm_tiling_validation/t6_3_mixed_${SLURM_JOB_ID:-manual}}"
...
echo
echo "Mixed WAC/static tiling validation completed successfully."
