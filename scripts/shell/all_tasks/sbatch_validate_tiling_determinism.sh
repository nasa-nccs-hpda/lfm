#!/usr/bin/env bash
#SBATCH --job-name=tiling_determinism
#SBATCH --partition=grace
#SBATCH --mem=96G
#SBATCH --cpus-per-task=8
#SBATCH --time=04:00:00
#SBATCH --output=scripts/logs/tiling_determinism_%j.out
#SBATCH --error=scripts/logs/tiling_determinism_%j.err
...
SCRIPT_REL="scripts/python/all_tasks/validate_tiling_determinism.py"
...
OUTPUT_DIR="${OUTPUT_DIR:-/explore/nobackup/people/${USER}/lfm_tiling_determinism_${SLURM_JOB_ID:-manual}}"
...
echo
echo "Tiling determinism validation completed successfully."
echo "Report: ${OUTPUT_DIR}/determinism_report.json"
