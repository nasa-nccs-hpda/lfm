#!/usr/bin/env bash
#SBATCH --job-name=validate_wac_tiling
#SBATCH --partition=grace
#SBATCH --mem=32G
#SBATCH --cpus-per-task=4
#SBATCH --time=01:00:00
#SBATCH --output=scripts/logs/validate_wac_tiling_%j.out
#SBATCH --error=scripts/logs/validate_wac_tiling_%j.err
...
SCRIPT_REL="scripts/python/all_tasks/validate_wac_tiling.py"
...
OUTPUT_DIR="${OUTPUT_DIR:-/explore/nobackup/people/${USER}/lfm_tiling_validation/t6_1_wac_${SLURM_JOB_ID:-manual}}"
...
echo
echo "WAC tiling validation completed successfully."
