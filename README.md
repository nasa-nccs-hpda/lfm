...
- `chip_example.ipynb` demonstrates using a WAC 300x300 chip and its matching label information to create a full WAC + static chip, using the Armstrong tiling code and some reprojection operations. This notebook also contains examples on how to create a full dataset from a previous dataset, splittng chips into train/val/test.
