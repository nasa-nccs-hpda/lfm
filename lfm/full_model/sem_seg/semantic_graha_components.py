"""Direct Graha/Lunar-FM semantic segmentation fine-tuning workflow.

This is the reusable implementation behind ``semantic_seg_finetuning.py`` and
``semantic_seg_finetuning.ipynb``.
...
def infer_train_num_channels(config: FineTuningConfig, datamodule_cls) -> int:
