"""GFFT semantic segmentation model adapter."""
...
from lfm.full_model.sem_seg import semantic_gfft_components as components


class GfftSemanticModelAdapter(SemanticModelAdapter):
    """Adapter for GFFT/Fourier-VQ MultiMAE semantic segmentation workflows."""
