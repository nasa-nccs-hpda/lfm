"""GFFT instance segmentation model adapter."""
...
from lfm.full_model.inst_seg import instance_gfft_components as components


class GfftInstanceModelAdapter(InstanceModelAdapter):
    """Adapter for GFFT/Fourier-VQ MultiMAE instance segmentation workflows."""
