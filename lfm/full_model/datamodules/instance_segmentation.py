...
class LunarObjectDetectionInstanceSegmentationDataset(LunarInstanceSegmentationDataset):
...
class LunarObjectDetectionInstanceSegmentationDatamodule(LunarSegmentationDatamodule):
    """Instance datamodule emitting TerraTorch ObjectDetectionTask targets."""

    dataset_cls = LunarObjectDetectionInstanceSegmentationDataset
